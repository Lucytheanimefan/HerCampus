 	...
 	var D = "",
 		...
 		L = {
 			...
 			callback: function(a) {
 				...
 				c.innerHTML = a.body;
 				"undefined" === typeof c.getElementsByClassName && (B = !1);
 				a = [];
 				var k = [],
 					f = [],
 					h = [],
 				...
 				if (B)
 					for (c = c.getElementsByClassName("timeline-Tweet"); e < c.length;) {
 						...
 						if (!b[e] || b[e] && C) a.push(c[e].getElementsByClassName("timeline-Tweet-text")[0]),
 						...
 						for (c = l(c, "timeline-Tweet"); e < c.length;) {
 							...
 							if (!b[e] ||
 								b[e] && C) a.push(l(c[e], "timeline-Tweet-text")[0]), q.push(c[e].getAttribute("data-tweet-id")), k.push(m(l(c[e], "timeline-Tweet-author")[0])), f.push(l(c[e], "dt-updated")[0]), n.push(l(c[e], "timeline-Tweet-timestamp")[0]), void 0 !== l(c[e], "timeline-Tweet-media")[0] ? h.push(l(c[e], "timeline-Tweet-media")[0]) : h.push(void 0);
 							e++
 						}
 				...
 				if (K)
 					...
 					for (; d < e;) {
 						...
 						b = "";
 						G ? (t && (E(a[d]), x && E(k[d])), x && (b += '<div class="user">' + p(k[d].innerHTML) + "</div>"), b += '<p class="tweet">' + p(a[d].innerHTML) + "</p>", z && (b = J ? b + ('<p class="timePosted"><a href="' + n[d] + '">' + f[d].getAttribute("aria-label") + "</a></p>") : b + ('<p class="timePosted">' + f[d].getAttribute("aria-label") + "</p>"))) : (x && (b += '<p class="user">' + k[d].textContent + "</p>"), b += '<p class="tweet">' + a[d].textContent + "</p>", z && (b += '<p class="timePosted">' + f[d].textContent + "</p>"));
 						H && (b +=
 ...
 var config1 = {
 	"id": '713352832632664064', //'713345526339608577',
 	"domId": 'example1',
 	"maxTweets": 6,
 	"enableLinks": true,
 	"showUser": true,
